...
Shader "MyShaders/Ray"
{
	Properties
	{
		...
		[ASEEnd]_XZValue("XZValue", Range( 0 , 1)) = 0
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float lerpResult89 = lerp( ( abs( WorldPosition.x ) * -1.0 ) , ( abs( WorldPosition.z ) * -1.0 ) , _XZValue);
				float2 temp_cast_1 = (lerpResult89).xx;
				float2 panner25 = ( _TimeParameters.x * temp_cast_0 + temp_cast_1);
				float4 lerpResult34 = lerp( float4( 0,0,0,0 ) , ( tex2D( _LineTexture, panner25 ).a * _LineColor ) , _Energy);
...
/*ASEBEGIN
Version=18600
263;378;724;319;2459.754;97.55463;3.004867;False;False
...
Node;AmplifyShaderEditor.ColorNode;6;-1028.218,89.8334;Inherit;False;Property;_ActivatedTint;ActivatedTint;1;0;Create;True;0;0;False;0;False;0.7075472,0.1568619,0.660006,0;0.7176471,0.01568627,0.3975587,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleTimeNode;27;-1677.106,698.8323;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;13;-907.9869,687.6221;Inherit;False;Property;_LineColor;LineColor;4;0;Create;True;0;0;False;0;False;0,0,0,0;0.03773582,0.03773582,0.03773582,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;26;-1675.406,620.7323;Inherit;False;Property;_LineSpeed;LineSpeed;5;0;Create;True;0;0;False;0;False;0;5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;8;-1024.325,-111.8244;Inherit;False;Property;_DeactivatedTint;DeactivatedTint;2;0;Create;True;0;0;False;0;False;0,0,0,0;0.4528302,0.07475969,0.4033774,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;14;-668.7708,563.1998;Inherit;True;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.PannerNode;25;-1432.938,603.5419;Inherit;True;3;0;FLOAT2;0,0;False;2;FLOAT2;0,0;False;1;FLOAT;1;False;1;FLOAT2;0
Node;AmplifyShaderEditor.LerpOp;89;-1741.075,300.9173;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.WorldPosInputsNode;81;-2266.413,220.7214;Inherit;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.AbsOpNode;87;-2053.281,244.3485;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;88;-1927.029,245.7654;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;-1;False;1;FLOAT;0
Node;AmplifyShaderEditor.AbsOpNode;85;-2056.619,357.76;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;86;-1930.369,359.1769;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;-1;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;90;-2036.672,478.766;Inherit;False;Property;_XZValue;XZValue;6;0;Create;True;0;0;False;0;False;0;0.5;0;1;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=0376C9AE7041195533654BAD8472D5094F79D444